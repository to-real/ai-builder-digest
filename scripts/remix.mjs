...
export function buildSystemPrompt(prompts) {
  return [
    ...
    '',
    '### 今日速览',
    '<3-5 sentences summarizing today\'s core themes and the single most important takeaway — lets a reader decide in 10 seconds whether the issue is worth reading. Then its Chinese translation.>',
    '',
    '### X / TWITTER',
    '## <Builder full name>',
    '',
